...
function detalheFilme(idfilme) {
    const detalhe_filme = `https://api.themoviedb.org/3/movie/${idfilme}?api_key=1eaaec06df7e280afc974183801dc23a&language=pt-BR`;
    ...
    // chamando a classe fechar que esta no arquivo css e formata o botão fechar
    ...
    // realizar a chamada de api com os dados do filme expecificos 
   fetch(detalhe_filme)
