/* 
Estamos usando o comando export para realizar a importação das funções dentro de arquivos
 javascript e , assim utilizar apenas uma chamada de javascript no html
*/
